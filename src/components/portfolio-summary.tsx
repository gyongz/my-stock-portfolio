...
export default function PortfolioSummary({
  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-2.5 px-4 py-3">
      {/* 总资产 */}
      <div className="min-w-0 bg-[#2c2c2e] rounded-xl p-3 sm:p-3.5">
        <div className="text-[11px] text-[#98989d] mb-1.5 tracking-tight">持仓总市值</div>
        <div className="text-[clamp(1.125rem,3vw,1.5rem)] font-semibold text-white font-mono tracking-tight">
      ...
      {/* 持仓数量 + 刷新 */}
      <div className="min-w-0 bg-[#2c2c2e] rounded-xl p-3 sm:p-3.5 flex flex-col">
        <div className="text-[11px] text-[#98989d] mb-1.5 tracking-tight">持仓数</div>
        <div className="flex items-center justify-between">
          <span className="text-[clamp(1.125rem,3vw,1.5rem)] font-semibold text-white font-mono tracking-tight">{holdings.length}</span>
          <button
            onClick={onRefresh}
